...
export class UsuarioService {
  ...
  renovatoken() {
    ...
    return this.http.get(url)
      ...
      .catch(err => {
        ...
        swal("Token não pode ser renovado", "Erro ao renovar token",  "error");
  ...
  trocarImagem(arquivo: File, id: string) {
    // 173

    this._subindoArquivoService
      .subirArquivo(arquivo, "usuarios", id)
      .then((resp: any) => {
        console.log(resp);
